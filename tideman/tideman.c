...
void sort_pairs(void)
{
    for (int i = 0; i < pair_count; i++)
    {
        for (int j = 0; j < pair_count; j++)
        {
            ...
            if ((preferences[pairs[i].winner][pairs[i].loser] - preferences[pairs[j].winner][pairs[j].loser]) < (preferences[pairs[j].winner][pairs[j].loser] - preferences[pairs[i].winner][pairs[i].loser]) && (i != j))
            {
                int winner;
                int loser;
